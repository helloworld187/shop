...
<body>
	...
	<div style="width: 1000px;height: 600px;margin:0 auto;margin-top:20px;border: 2px solid #FE8502; font-size: 20px;color:grey">
		<div style="margin:40px">
			<h1 style="text-align: center; color:#FE8502;font-weight: bold;font-size: 30px; ">商品上架</h1>
			<hr style="height:3px;;border:none;border-top:3px dotted #FE8502; " />
			<form action="goods/uploadgoods?goodsid=${Goods.goodsid}" method="post" id="upload" style="margin-top: 20px">
				<font>商品名称：</font><input type="text"  class="goodsname" name="goodsname" style="width:300px;height:20px;"/><br/><br/>
				<font>商品描述：</font><br/>
				<textarea rows="5" class="gdescription" name="gdescription" cols="90" style="margin-left:100px;"></textarea><br/><br/>
				<font>商品价格:</font><input type="text" class="gprice" name="gprice" style="margin-left:13px;width:200px;height:20px;"/><br/><br/>
				<div class="shur shur3">
				<font>商品分类:</font><br/>
					<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-left:100px;">
						<tr valign="top">
							<td width="15%" id="catesSelect">
								<select id="classify" class="catselect2" size="8" name="categoryid"></select>
							</td>
						</tr>
					</table>
					<br/><br/>
				<input type="submit" value="提交" style="width:80px;height:30px;margin-left:100px;border:none;font-size:15px;
				color:white;background:#FE8502;border-radius: 5px;"/>
			</form>
		</div>
	</div>
	</body>
