	...
	<div class="shop_member_bd clearfix">
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				<div class="title"><h3>总订单列表</h3></div>
				<table>
					<thead class="tab_title">
						<th style="width:410px;"><span>商品信息</span></th>
						<th style="width:100px;"><span>收货地址</span></th>
						<th style="width:100px;"><span>购买时间</span></th>
						<th style="width:100px;"><span>数量</span></th>
						<th style="width:115px;"><span>总价</span></th>
					</thead>
					<tbody>

						<tr><td colspan="5">
							<table class="good" style="border-collapse:separate; border-spacing:0px 10px;">
								<c:forEach items="${orders}" var="order">
						    		<thead >
										<tr><th colspan="6">
											<span><strong>订单编号：</strong><a href="orderDetails/findDtailsByOrdersid?ordersid=${order.ordersid}">${order.ordersid}</a></span>
										</th></tr>
									</thead>
									<tbody>
										<tr>
											<td class="dingdan_pic"><img src="images/close.gif"/><br/></td>
											<td class="dingdan_title"><span><a href="orderDetails/findDtailsByOrdersid?ordersid=${order.ordersid}">点击查看商品详情</a></span><br /> </td>
											<td class="dingdan_shuliang">${order.addressid}</td>
											<td class="dingdan_danjia"><strong>${order.ordertime}</strong></td>
											<td class="dingdan_shuliang">1</td>
											<td class="dingdan_zongjia">￥<strong>${order.totalprice}</strong><br />(免运费)</td>
											<!-- <td class="digndan_caozuo"><a href="goods/find?goodsid=${goods.goodsid}">评价</a></td> -->
										</tr>
									</tbody>
								</c:forEach>
							</table>
