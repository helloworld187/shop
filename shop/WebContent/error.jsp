...
<head>
    ...
    <style type="text/css">
		...
		.shop_bd_error p{height:46px; line-height:46px; width:980px; text-align: center; font-size:14px; font-weight: bold; color:#55556F;}
		.shop_bd_error p .error{display:inline-block;width:46px; height:46px; line-height:46px; overflow:hidden; text-indent: 99em; vertical-align:top; padding-right:10px; background:url('images/error.jpg') no-repeat left top;}
		.shop_bd_error p .success{display:inline-block;width:46px; height:46px; line-height:46px; overflow:hidden; text-indent: 99em; vertical-align:top; padding-right:10px; background:url('images/success.jpg') no-repeat left top;}
    </style>
</head>
 <body>
	...
	<div class="shop_bd_error">
		<p><span class="success">出错啦！</span>出错啦！</p>
	</div>
	<!-- Body End -->
