...
<body>
	...
	<div style="width: 1000px;height: 500px;margin:0 auto;margin-top:20px;border: 2px solid #FE8502; font-size: 20px;color:grey">
		<div style="margin:40px">
			<a href="uploadgoods.jsp"><img  align="absmiddle" class="inline" src="image/back.png" style="width: 50px;height: 50px;"/>
			</a>
			<span class="inline" style="margin-left:250px;color:#FE8502;font-weight: bold;font-size: 30px; ">上传更多图片</span>
			<hr style="height:3px;border:none;border-top:3px dotted #FE8502; " />
				<div class="grzl" style="margin-top: 30px;">
				<font>请上传商品图片:</font><br/><br/>
				<form action="picture/uploadpictures?goodsid=${Goods.goodsid}" method="post" enctype="multipart/form-data">
					<input type="file" name="image" id="image" />${message}<br/><br/>
					<img src="image/上传.png" style="width: 150px;height: 150px;"/><br/><br/>		
