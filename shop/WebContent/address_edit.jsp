...
<head>
    ...
    $(function(){
		...
		$(".xiangxi").val('${Address.addressinfo}');
		$(".youbian").val('${Address.zipcode}');
		$(".dianhua").val('${Address.telephone}');
	});
</script>
</head>
<body>
					...
					<form athion="" name="" class="shop_form" method="post">
						<ul>
							...
							<li class="bn"><label>&nbsp;</label>
								<input type="button" class="form-submit" value="保存修改" id="update"/></li>
						</ul>
					</form>
				</div>
			</div>
...
<script type="text/javascript">
	$('#update').click(function(){
		...
		$.ajax({
			...
			type:"post",
			data:{addressid:addressid,userid:${user.userid},name:name,addressinfo:address,zipcode:code,telephone:tel},
