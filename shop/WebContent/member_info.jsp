...
<head>
	...
	function updateuser(){
		...
		$.ajax({
			...
			type:"post",
			data:{userid:${user.userid},username:uname,password:pwd,email:email,telephone:tel,gender:gender},
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="toindex.jsp">ShopCZ商城</a></b>[<font style="color:red">${user.username}</font>]</p>
				</div>
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					...
					<form athion="" name="" class="shop_form" method="post">
						<ul>
							<li><label>用户名称：</label>
								<input type="text" class="truename form-text" name="username" id="username"/></li>
							<li><label>密码：</label>
								<input type="password" class="truename form-text" name="password" id="password"/></li>
							<li><label>电子邮件：</label>
								<input type="text" class="truename form-text" name="email" id="email"/></li>
							<li><label>联系电话：</label>
								<input type="text" class="truename form-text" name="telephone" id="telephone"/></li>
							<li><label>性别:</label>
								<input type="radio" class="ml10 mr5" name="sex" value="男" id="male" />男
								<input type="radio" class="ml10 mr5" name="sex" value="女" id="female"/>女
							</li>
							<li class="bn"><label>&nbsp;</label><input type="button" onclick="updateuser()" class="form-submit" value="保存修改" /></li>
						</ul>
					</form>
				</div>
			</div>
