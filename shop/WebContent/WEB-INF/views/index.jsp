...
<head>
	...
	<link rel="stylesheet" href="css/shop_header.css" type="text/css" />
        ...
        <script type="text/javascript" src="plugins/jquery-3.3.1.mins.js"></script>
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p><font style="color:red">${currentUser.username}</font>您好，欢迎来到<b><a href="/">ShopCZ商城</a></b>[<a href="login.jsp">登录</a>][<a href="register.jsp">注册</a>]</p>
				</div>
				...
				<div class="shop_hd_topNav_all_right">
					<ul class="topNav_quick_menu">
						...
						<li>
							<div class="topNav_menu">
								<a href="shoppinglist.html" class="topNavHover">购物车<b>0</b>种商品<i></i></a>
								<div class="topNav_menu_bd" style="display:none;">
									<!--
						            <ul>
						              <li><a title="已售出的商品" target="_top" href="#">已售出的商品</a></li>
			...
			<div class="shop_hd_menu_all_category shop_hd_menu_hover"><!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
				...
				<div id="shop_hd_menu_all_category_hd" class="shop_hd_menu_all_category_hd">
					<ul class="shop_hd_menu_all_category_hd_menu clearfix" id="menu">
						...
						<li id="cat_1" class="">
							<h3><a href="" title="男女服装">${list.categoryName}</a></h3>
						</li>
						</c:forEach>
						<!--  
						<li id="cat_2" class="">
	...
	function catrgory(){
		$.ajax({
			...
			success:function(list){
				...
				console.log(qList);
				for(var i=1;i<8;i++){
					$("#menu").append("<li id="cat_1" class=""><h3><a href="" title="男女服装">"+
